...
CFLAGS = -Wall -mips32 -O3 -Wextra -fthread-jumps -fexpensive-optimizations -ffast-math -I/opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/include/lua -I/opt/gcw0-toolchain/usr/include
...
host_vendor = unknown
htmldir = ${docdir}
includedir = /opt/gcw0-toolchain/usr/include:/opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/include
...
lua_CFLAGS = -I/opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/include/lua  
lua_LIBS = -L/opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/lib -llua  
